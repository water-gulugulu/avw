  ...
  <div>
    <div class="search-term">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">          
        ...
        <el-form-item>
          <el-button @click="openDialog" type="primary">新增卡牌转让</el-button>
        </el-form-item>
        <el-form-item>
    ...
    <el-table-column label="卡牌出售价格" prop="price" width="120"></el-table-column> 
    ...
    <el-table-column label="卡牌名称" prop="cardName" width="120"></el-table-column> 
    
    <el-table-column label="交易hash" prop="txHash" width="120"></el-table-column> 
    
    <el-table-column label="出售人" prop="from" width="120"></el-table-column> 
    
    <el-table-column label="购买人" prop="to" width="120"></el-table-column> 
    
    <el-table-column label="区块号" prop="block" width="120"></el-table-column> 
    
    <el-table-column label="手续费地址" prop="system" width="120"></el-table-column> 
    
      <el-table-column label="按钮组">
        <template slot-scope="scope">
          <el-button class="table-button" @click="updateAvfCardTransfer(scope.row)" size="small" type="primary" icon="el-icon-edit">变更</el-button>
...
import {
    ...
    deleteAvfCardTransfer,
    deleteAvfCardTransferByIds,
    updateAvfCardTransfer,
    findAvfCardTransfer,
    getAvfCardTransferList
...
export default {
  ...
  data() {
    return {
      listApi: getAvfCardTransferList,
  ...
  methods: {
      ...
      deleteRow(row){
        this.$confirm('确定要删除吗?', '提示', {
          ...
          type: 'warning'
           ...
           this.deleteAvfCardTransfer(row);
        });
      },
      async onDelete() {
        const ids = []
        ...
        const res = await deleteAvfCardTransferByIds({ ids })
        if (res.code == 0) {
          this.$message({
            type: 'success',
            message: '删除成功'
    ...
    async updateAvfCardTransfer(row) {
      const res = await findAvfCardTransfer({ ID: row.ID });
      this.type = "update";
      if (res.code == 0) {
    ...
    async deleteAvfCardTransfer(row) {
      const res = await deleteAvfCardTransfer({ ID: row.ID });
      if (res.code == 0) {
        this.$message({
          type: "success",
          message: "删除成功"
