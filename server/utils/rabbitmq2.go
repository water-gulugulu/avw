...
func (r *RabbitMQ) mqConnect() {
	var err error
	// RabbitUrl := fmt.Sprintf("amqp://%s:%s@%s:%d", "root", "123123", "127.0.0.1", 5672)
	// fmt.Printf("url:%s,amqp://root:123123@127.0.0.1:5672\n", RabbitUrl)
	mqConn, err = amqp.Dial("amqp://root:123123@127.0.0.1:5672")
