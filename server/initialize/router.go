...
func Routers() *gin.Engine {
	...
	PrivateGroup.Use(middleware.JWTAuth(), middleware.CasbinHandler())
	{
		...
		router.InitAvfEventLogRouter(PrivateGroup)
		router.InitAvfCardRouter(PrivateGroup)
		router.InitAvfUserRouter(PrivateGroup)
		router.InitAvfOrderRouter(PrivateGroup)
		router.InitAvfOrderCardRouter(PrivateGroup)
		router.InitAvfCardTransferRouter(PrivateGroup)
		router.InitAvfUserBillRouter(PrivateGroup)
