...
var doc = `{
    ...
    "paths": {
        ...
        "/avfUserBill/deleteAvfUserBillByIds": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/avfUserBill/getAvfUserBillList": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "description": "分页获取AvfUserBill列表",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.AvfUserBillSearch"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/web_tools.MyCardDetailResponse"
                        }
                    }
                }
            }
        },
        "/web/order_card/payFees": {
            "post": {
                "consumes": [
                    "application/x-www-form-urlencoded"
                ],
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/web_tools.MyStatisticalResponse"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/web_tools.StatisticalResponse"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "web_tools.MyCardDetailResponse": {
            "type": "object",
            "properties": {
                "all": {
                    "description": "全部收益",
        ...
        "web_tools.MyStatisticalResponse": {
            "type": "object",
            "properties": {
                "all_earnings": {
                    "description": "总收益",
        ...
        "web_tools.OrderDetailResponse": {
            ...
            "properties": {
                "order_card_list": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/web_tools.AvfOrderCard"
                    }
                },
                "order_info": {
                    "description": "订单详情",
